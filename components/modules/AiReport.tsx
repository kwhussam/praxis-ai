  ...
  return (
    <GlassCard>
      <View style={styles.header}>
        <Text style={styles.kicker}>Claude Security Analyst</Text>
        <AmpelBadge tone={ampelTone(report.ampel)} label={`Ampel: ${report.ampel.toUpperCase()}`} pulsing={report.ampel === "rot"} />
      </View>
      <Text style={styles.score}>{report.security_score}/100</Text>
      <Text style={styles.summary}>{report.executive_summary}</Text>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Top-Risiken</Text>
