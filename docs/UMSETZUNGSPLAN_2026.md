...
## 21. Aktuelle Startfreigabe

Die ursprüngliche Startfreigabe für Sprint 1 ist umgesetzt. Golden-Datensatz, gemeinsamer
...
Die Statuswörter beziehen sich bewusst auf unterschiedliche Ebenen. `released` bedeutet, dass für
das konkrete Arbeitspaket keine eigene Implementierungs- oder Reviewarbeit mehr offen ist.
`technically_complete` bedeutet dagegen nicht produktionsfreigegeben: externe Freigaben,
Schlüssel-/Betriebsentscheidungen oder reale Geräte-/Signing-Nachweise können weiterhin sperren.

| Kategorie | Arbeitspakete | Geschlossen | Noch offen |
|---|---|---|---|
| **Released** | SP1-05, SP2-03 | Dashboard-Wahrheitskette, vergleichbare Historie, Praxis-/Techniksicht, Coverage-/Freshness-Kommunikation und responsive A11y-Abnahme | keine paketinterne Arbeit; physische Gerätematrix bleibt übergeordnetes Produktions-Gate |
| **Implementierung geschlossen, Produktions-Gates offen** | SP3-01B | Expo SDK 57 / Expo 57.0.24 / RN 0.86.3 / React 19.2.3, Hermes-v1-Fix, leere Dependency-Allowlist und automatisierte Upgrade-Gates; Patchstand über PR #61 gemergt | vollständiger 15/15-Simulator-Wiederholungslauf, physische iOS-/Android-Matrix sowie echtes Store-Signing |
| **Technisch abgeschlossen, durch Owner-Entscheidungen blockiert** | SP3-02 Phase A+B | Recovery-Inventar, G-01-Löschscope, synthetischer Zwei-Mandanten-Restore-Drill 8/8 und Snapshot-Canaries | D-01 bis D-10 sind noch nicht entschieden; besonders D-05/D-06/D-07 blockieren Schlüsselrotation und Snapshot-Cutover, D-08/D-09/D-10 den Incident-Tabletop; RPO/RTO ohne Produktionsclaim |
...
| SP1-05 | released | Dashboardprimärwert und Historie nutzen nur vergleichbare Fragebogenergebnisse; WLAN/Monitoring können ihn nicht ersetzen; finale Praxis-/Techniksicht und A11y-Abnahme sind über SP2-03 nachgewiesen | keine SP1-05-Arbeit offen |
