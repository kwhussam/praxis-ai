...
| SP3-02 | planning | isolierter Branch `codex/sp3-02-recovery-tabletop`; phasenweiser Plan mit Daten-/Schlüsselinventar, synthetischem Restore-Drill, Rotationsnachweis, Incident-Tabletop und evidenzgebundener Abnahme | Phase-A-Istaufnahme; benannte Operations-/Product-/Security-Owner; freigegebene RPO/RTO-, Retention-, KEK/KMS- und Notfallrollenentscheidungen; ausführbare lokale/Staging-Nachweise ohne Produktionsdaten |
