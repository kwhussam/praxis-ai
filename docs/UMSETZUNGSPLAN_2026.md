...
| B-M-03 | P0-03, P1-01 | SP2-04 in verification; unabhängiges Review und Native-Smokes offen |
...
Stand: **2026-08-11**, lokaler Arbeitsstand; noch kein Produktionsrelease.
...
Nicht als erledigt markiert bleiben die vollständige Claim-Inventur, die physische Android-/iOS-Gerätematrix einschließlich des SP2-04-PDF-Cache-Smokes und die freizugebende Datenmigration. Assessment-Manifest und kanonischer PDF-Pfad befinden sich in `verification` und benötigen vor `released` noch das unabhängige Security-/Privacy-Review.
