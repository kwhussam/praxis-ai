...
| SP3-02 | Phase A `audit_completed`; Phase B `measured_blocked_by_G-01`; Release `blocked_by_owner_decisions` | isolierter Branch `codex/sp3-02-recovery-tabletop`; **Phase A vollständig durchgeführt**: `docs/SP3_02_RECOVERY_INVENTORY.md` inventarisiert am tatsächlichen Code zehn Bestandsgruppen und 24 priorisierte Lücken; `docs/SP3_02_DECISION_LOG.md` führt zehn offene Entscheidungen D-01 bis D-10. **Phase B ist reproduzierbar implementiert und lokal gemessen:** synthetischer Zwei-Mandanten-Dump der verantworteten Anwendungsschemata, isolierte Restore-Datenbank, P-01 bis P-08, Metadaten-only-Evidenz; Referenzlauf 7/8 mit 242/242 pgTAP-Assertions, identischen RLS-/Policy-/Grant-Snapshots, identischen kanonischen Report-/PDF-Hashes und fail-closed Schlüsselprüfung. P-06 bestätigt G-01, weil sechs D2-Tabellen trotz abgeschlossener Löschung verbleiben. Lokale Messung: 234 ms Backup, 491 ms Restore; kein Produktionsclaim | ausdrückliche Owner-Freigabe für die produktionswirksame G-01-Löschmigration, pgTAP-Regression und erneuter 8/8-Drill; null von zehn Owner-Entscheidungen sind `decided`, daher bleiben Produktionsübertragbarkeit und Freigabe gesperrt; Phase C benötigt D-05/D-06/D-07, Phase D D-08/D-09/D-10; RPO/RTO bleiben unbestimmt bis produktionsrepräsentativer Messung **und** Freigabe |
