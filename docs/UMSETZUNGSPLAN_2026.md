...
Nicht als erledigt markiert bleiben die vollständige Claim-Inventur, die physische Android-/iOS-Gerätematrix einschließlich des SP2-04-PDF-Export-/Öffnen-/Cleanup-Smokes und die freizugebende Datenmigration. Das technische SP2-04-Review ist ohne P1/P2 bestanden; vor `released` fehlen weiterhin CI nach Push, Datenschutz-Sign-off/ADR-001 und die externe D1-Rechtsprüfung. Der vorbestehende Lösch-RPC-Umfang für Inventar-/Monitoring-Target-Tabellen bleibt ausdrücklich ADR-001-Blocker vor M5.
